...
int main() {
    ...
    Jet_Generator_Optimized(
        "Train_T2",    // output_base_name (Typically just "Train" or "Test")
        ...
        1,          // fastjet_accept_index [int] (If =0, accepts events with any jet in min/max. If >0, only accepts events with one of top N jets in min/max.)
