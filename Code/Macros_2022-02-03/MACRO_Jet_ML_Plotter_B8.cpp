...
void MACRO_Jet_ML_Plotter_B8() {
    ...
    char ml_results_array[8][2][100] = {
        {"ML_Results_LR_Only/12_Feature/Test_4GeV_Bins/Train_B8_F12_10_90_Test_18_22.csv", "Tree_Train_B8_F12_10_90_Test_18_22"},
        {"ML_Results_LR_Only/12_Feature/Test_4GeV_Bins/Train_B8_F12_10_90_Test_28_32.csv", "Tree_Train_B8_F12_10_90_Test_28_32"},
        {"ML_Results_LR_Only/12_Feature/Test_4GeV_Bins/Train_B8_F12_10_90_Test_38_42.csv", "Tree_Train_B8_F12_10_90_Test_38_42"},
        {"ML_Results_LR_Only/12_Feature/Test_4GeV_Bins/Train_B8_F12_10_90_Test_48_52.csv", "Tree_Train_B8_F12_10_90_Test_48_52"},
        {"ML_Results_LR_Only/12_Feature/Test_4GeV_Bins/Train_B8_F12_10_90_Test_58_62.csv", "Tree_Train_B8_F12_10_90_Test_58_62"},
        {"ML_Results_LR_Only/12_Feature/Test_4GeV_Bins/Train_B8_F12_10_90_Test_68_72.csv", "Tree_Train_B8_F12_10_90_Test_68_72"},
        {"ML_Results_LR_Only/12_Feature/Test_4GeV_Bins/Train_B8_F12_10_90_Test_78_82.csv", "Tree_Train_B8_F12_10_90_Test_78_82"},
        {"ML_Results_LR_Only/12_Feature/Test_4GeV_Bins/Train_B8_F12_10_90_Test_40_60.csv", "Tree_Train_B8_F12_10_90_Test_40_60"}
    };
    ...
    char ml_weights_array_2[7][2][100] = {
        {"ML_Results_LR_Only/12_Feature/Train_20GeV_Bins/Train_B8_F12_10_30_LR_Coeffs.csv", "Train_B8_F12_10_30_Test_10_30"},
    ...
    for ( int i = 0 ; i < 8 ; i++ ) {
        ...
        sprintf(
            ...
            "%ML_Results_LR_Only/12_Feature/Test_4GeV_Bins/Plots_Actual/Plot_Train_B8_F12_%.0f_%.0f_Test_%.0f_%.0f",
            dir_data,
        ...
        sprintf(
            ...
            "%ML_Results_LR_Only/12_Feature/Test_4GeV_Bins/Plots_Delta/Plot_Train_B8_F12_%.0f_%.0f_Test_%.0f_%.0f",
            dir_data,
            test_min_max_array[i][0],
            test_min_max_array[i][1],
            test_min_max_array[i][0],
    ...
    for ( int i = 0 ; i < 7 ; i++ ) {
        ...
        sprintf(
            plot_file_name_actual,
            "%ML_Results_LR_Only/12_Feature/Train_20GeV_Bins/Plots_Actual/Plot_Train_B8_F12_%.0f_%.0f_Test_%.0f_%.0f",
            dir_data,
        ...
        sprintf(
            plot_file_name_delta,
            "%ML_Results_LR_Only/12_Feature/Train_20GeV_Bins/Plots_Delta/Plot_Train_B8_F12_%.0f_%.0f_Test_%.0f_%.0f",
            dir_data,
            test_min_max_array_2[i][0],
            test_min_max_array_2[i][1],
            test_min_max_array_2[i][0],
    ...
    sprintf(coeff_plot_file_path_2, "%ML_Results_LR_Only/12_Feature/Train_20GeV_Bins/ML_Train_B8_F12_10_90_Coefficients.pdf", dir_data);
    char coeff_plot_file_path_2B[200];
    sprintf(coeff_plot_file_path_2B, "%ML_Results_LR_Only/12_Feature/Train_20GeV_Bins/ML_Train_B8_F12_10_90_Coefficients_ShowInt.pdf", dir_data);
    ...
    for ( int i = 0 ; i < 6 ; i++ ) {
        ...
        sprintf(
            plot_file_name_actual,
            "%ML_Results_LR_Only/12_Feature/Train_30GeV_Bins/Plots_Actual/Plot_Train_B8_F12_%.0f_%.0f_Test_%.0f_%.0f",
            dir_data,
        ...
        sprintf(
            plot_file_name_delta,
            "%ML_Results_LR_Only/12_Feature/Train_30GeV_Bins/Plots_Delta/Plot_Train_B8_F12_%.0f_%.0f_Test_%.0f_%.0f",
            dir_data,
            test_min_max_array_3[i][0],
            test_min_max_array_3[i][1],
            test_min_max_array_3[i][0],
    ...
    sprintf(coeff_plot_file_path_3, "%ML_Results_LR_Only/12_Feature/Train_30GeV_Bins/ML_Train_B8_F12_10_90_Coefficients.pdf", dir_data);
    char coeff_plot_file_path_3B[200];
    sprintf(coeff_plot_file_path_3B, "%ML_Results_LR_Only/12_Feature/Train_30GeV_Bins/ML_Train_B8_F12_10_90_Coefficients_ShowInt.pdf", dir_data);
